    ...
    <ion-content :fullscreen="true">
      ...
      <ion-card>
        ...
        <ion-card-header>
          ...
          <ion-card-subtitle>「笑裡藏道」，曾興才著，天恩出版社，2016年11月初版，2022第七版。'</ion-card-subtitle>
        </ion-card-header>
      ...
      <ion-card>
        ...
        <ion-card-header>
          ...
          <ion-card-subtitle>來，領受一份 「幽默感」的恩膏！ 累積你的笑話存款，提升你的親和指數，打開分享真理的機會之門！'</ion-card-subtitle>
        </ion-card-header>
